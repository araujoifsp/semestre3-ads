...
<div class="container">
    ...
    <section class="section wow fadeIn" data-wow-delay="0.3s">
         @component('components.feature-heading', ['textcolor'=> 'purple-text', 'title' => 'Pizzaria', 'body' => 'Kill Them All'])
      ...
      <div class="row">
        ...
        <div class="col-md-4">
            ...
            @component('components.text-block',['icon' => 'fa-flag-checkerd', 'textcolor' => 'indigo-text', 'title' => 'Ultima geração'])
