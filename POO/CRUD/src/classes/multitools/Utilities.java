...
public class Utilities {
	...
	// Formato String pro Mysql
		
	public String dateToMySQLDate(Date date) {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		String mysqlDate = sdf.format(date);
		return mysqlDate;
	}
	
	public String dateToMySQLDateTime(Date date) {
	...
	public String dateToDatePtbr(Date date) {
	    SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
	    String mysqlDateTime = sdf.format(date);
	    return mysqlDateTime;
	}
	
	public String datetimeToDatePtbr(Date date) {
